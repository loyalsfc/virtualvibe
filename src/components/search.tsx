    ...
    return (
        <section className='bg-[#0A075F] py-[50px] px-4 md:px-0'>
            <div className="container mx-auto">
                <div className='max-w-[1086px] mx-auto font-switzer text-white grid grid-cols-1 md:grid-cols-3 gap-14 py-5'>
...
function Filters({title, value}:{title: string, value: string}){
    return(
        <div>
            ...
            <div className='relative border-b border-b-[#7778B0]'>
                <select name="" id="" className='text-[22px] font-bold bg-transparent w-full focus:outline-none'>
